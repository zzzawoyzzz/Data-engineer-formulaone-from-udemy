...
# Optionally, you can add <directory-name> to the source URI of your mount point.
dbutils.fs.mount(
  source = dbutils.secrets.get(scope="formula1-secret",key="publish-datalake"),
  mount_point = "/mnt/formula1/publish_datalake",
  extra_configs = configs)
...
# dbutils.fs.rm("/mnt/formula1/publish_datalake/",True)

# COMMAND ----------

display(dbutils.fs.ls('/mnt/formula1/publish_datalake'))

# COMMAND ----------

dbutils.fs.unmount('/mnt/formula1/publish_datalake')
